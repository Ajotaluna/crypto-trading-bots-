    ...
    def score_universe(pair_data, now_idx, top_n=10, long_ratio=None):
        ...
        for symbol, df in pair_data.items():
            ...
            try:
                ...
                # ============================================
                long_rejected = RawMarketScanner._is_trend_established(history, 'LONG')
                short_rejected = RawMarketScanner._is_trend_established(history, 'SHORT')
